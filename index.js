...
function FivePaisaClient(conf) {
  ...
  const WEBSOCKET_REQUEST_CODE='5PLoginCheck';
  ...
  this.login = function (email, password, DOB) {
    ...
    // this.loginPayload.body.Email_id = "qfUBpS1XInAr/L6g/9X3bCB4gwuXoT2HLyrk5WK3QIE=";
    // this.loginPayload.body.Password = "QRGMFiO0E0S9HRfgurQs/w==";
    // this.loginPayload.body.My2PIN = "O+mJBviaHkKLPC4Duy7vkw==";
